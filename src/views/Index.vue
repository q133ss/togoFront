  ...
  <div class="row">
    <div class="col-sm-6 mb-4 mb-xl-0">
      <div class="d-lg-flex align-items-center">
        <div>
          <h3 class="text-dark font-weight-bold mb-2">Аналитика продаж</h3>
...
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
              <h2 class="text-dark mb-2 font-weight-bold">{{retailPriceWithdiscRub ?? 'Данные отсутствуют'}}</h2>
              <h4 class="card-title mb-2">Цена розничная с уч. скидки</h4>
        ...
        <div class="col-lg-4 d-flex grid-margin stretch-card">
          <div class="card sale-diffrence-border">
            <div class="card-body">
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
              <h2 class="text-dark mb-2 font-weight-bold">{{spp ?? 'Данные отсутствуют'}}</h2>
              <h4 class="card-title mb-2">СПП, руб</h4>
              <small class="text-muted">APRIL 2019</small>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 d-flex grid-margin stretch-card">
          <div class="card sale-diffrence-border">
            <div class="card-body">
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
              <h2 class="text-dark mb-2 font-weight-bold">{{retailPriceWithdiscRubMinusSpp ?? 'Данные отсутствуют'}}</h2>
              <h4 class="card-title mb-2">Цена розничная с уч. скидки - СПП</h4>
              <small class="text-muted">APRIL 2019</small>
            </div>
          </div>
        </div>
...
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
        ...
        <div class="col-lg-4 d-flex grid-margin stretch-card">
          <div class="card sale-diffrence-border">
            <div class="card-body">
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
              <h2 class="text-dark mb-2 font-weight-bold">{{willList ?? 'Данные отсутствуют'}}</h2>
              <h4 class="card-title mb-2">WB перечислит</h4>
              <small class="text-muted">APRIL 2019</small>
            </div>
          </div>
        </div>
...
<!--              <i class="mdi mdi-alert-circle-outline"></i>-->
              <h2 class="text-dark mb-2 font-weight-bold">---</h2>
              <h4 class="card-title mb-2">Средний чек</h4>
              <small class="text-muted">APRIL 2019</small>
            </div>
          </div>
        </div>
